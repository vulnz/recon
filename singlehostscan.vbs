...
' =========================================
' 1. Ask user for a single host
' =========================================
target = InputBox("Enter host to scan (example: 172.18.96.10)", "Port Scanner")

If target = "" Then
    WScript.Echo "No host entered. Exiting."
    WScript.Quit
End If
...
' =========================================
' 3. Ping host before scanning
' =========================================
If Not PingHost(target) Then
    WScript.Echo "Host " & target & " is not reachable. Exiting."
    WScript.Quit
End If

WScript.Echo "Host reachable: " & target
WScript.Echo "Starting top 100 port scan..."
WScript.Echo "================================"

' =========================================
' 4. Scan top 100 ports for the host
' =========================================
For Each p In ports
    If CheckTCP(target, p) Then
